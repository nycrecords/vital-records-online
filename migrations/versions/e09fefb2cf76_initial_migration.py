...
def upgrade():
    ...
    sa.Column('type', sa.Enum('birth', 'death', 'marriage', 'marriage_license', name='certificate_type'), nullable=False),
    sa.Column('county', sa.Enum('bronx', 'kings', 'manhattan','queens','richmond', name='county'), nullable=False),
